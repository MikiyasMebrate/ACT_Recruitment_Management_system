    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recruitment_System.department')),
                ('skills', models.ManyToManyField(to='Recruitment_System.skill')),
                ('type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recruitment_System.job_type')),
            ],
        ),
        migrations.CreateModel(
            name='Interviews',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recruitment_System.candidate')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recruitment_System.candidate')),
                ('jobs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recruitment_System.job_posting')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
